// Keep the large embedded WebUI in a header so Arduino's automatic
// function-prototype generator does not parse JavaScript function syntax.
// Rename only the two PWA-facing constants so we can override them below
// without duplicating the diagnostics/update pages.
...
static const char PWA_ICON_URL[] = "https://raw.githubusercontent.com/antflix/t1n_smartlock/main/assets/sprinter-smart-lock-180.png";
